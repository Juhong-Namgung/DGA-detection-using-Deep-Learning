...
from keras.layers import Input, LSTM, Embedding, GRU
...
with tf.device("/GPU:0"):
    ...
    def gru(max_len=77, emb_dim=32, max_vocab_len=128, lstm_output_size=32, W_reg=regularizers.l2(1e-4)):
        # Input
        ...
        # LSTM layer
        lstm = GRU(units=128, recurrent_dropout=0.2)(emb)
